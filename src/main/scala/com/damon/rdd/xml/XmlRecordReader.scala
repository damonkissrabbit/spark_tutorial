...
object XmlRecordReader {
  def main(args: Array[String]): Unit = {
    ...
    javaPairRDD.foreach(new VoidFunction[(LongWritable, Text)]() {
      @throws[Exception]
      override def call(tuple: (LongWritable, Text)): Unit = { // TODO Auto-generated method stub
